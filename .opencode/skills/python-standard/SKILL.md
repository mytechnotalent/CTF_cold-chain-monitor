...
description: Python coding standard for owned tooling in datacenter-vent-controller-c-rp2350.
---

# Python Standard (datacenter-vent-controller-c-rp2350)

Owned Python files under `scripts/` and `test/` and any future tooling must
comply with strict PEP8, an eight-line executable function-body limit, no blank
lines inside function bodies, and complete NumPy-style docstrings.
